package com.time.cat.demo.lock;
        ...
        delayRunnableUtils = new DelayRunnableUtils(new Runnable() {
            ...
            public void run() {
                ...
                if (holdingView instanceof GestureLockView) {
                    ((GestureLockView) holdingView).onActionStart();
                }
            }
        }, 500);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                childId = calculateChildIdByCoords(lastX, lastY);
                holdingView = findViewById(childId + 1);

                delayRunnableUtils.start();
                Log.e("GestureLock", "ACTION_DOWN");
                break;
            case MotionEvent.ACTION_MOVE:
                ...
                cId = calculateChildIdByCoords(lastX, lastY);
                Log.e("GestureLock", "ACTION_MOVE (" + cId + " == " + childId + ")" + " " + forceClear);
